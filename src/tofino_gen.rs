...
pub fn fill_p4code<'a> (import_map : &HashMap<String, String>, my_globals : &Globals<'a>, packet_map : &HashMap<String, String>, my_dag : &mut Dag<'a>,
    pkt_tree : &Packets<'a>, my_packets : &Packets<'a>) {
